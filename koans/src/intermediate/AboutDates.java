...
public class AboutDates {
	...
	public void dateToString() {
		assertEquals(date.toString(), "Sat Mar 03 22:33:21 EST 1973");
	}
	...
	public void changingDateValue() {
		...
		assertEquals(date.toString(), "Sat Mar 03 23:33:21 EST 1973");
	}
	...
	public void usingCalendarToChangeDates() {
		...
		assertEquals(cal.getTime().toString(), "Tue Apr 03 23:33:21 EST 1973");
	}
	...
	public void usingRollToChangeDatesDoesntWrapOtherFields() {
		...
		assertEquals(cal.getTime().toString(),  "Sat Mar 03 23:33:21 EST 1973");
	}
	...
	public void usingDateFormatToFormatDateShort() {
		...
		assertEquals(formattedDate, "3/03/73");
	}
